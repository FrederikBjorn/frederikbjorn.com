...
comprised of different legth loops, which are recordings of a fireplace with different distances.
The fourth loop is an ambisoic sound, which we will come back to.
First; the three mono events which all utilise the Google resonance tool, <em> Resonance Audio Source</em>,
basiclly Google resonance was of fitting a mono sound source in a 3D world. <br><br><img src="Resonance_Audio_Source_fireplace_very_close.png" alt="Resonance_Audio_Source_fireplace_very_close.png" align="center" width=100%"><br>

Here we see the Resonance Audio Source for the FirePlace_VeryClose event.
A quick walk through of this tools is that we use to determeine from how far/close we can here the sound, and how the attenuation and spread affects the sound.
...
example but with different samples (recorded acordingly to the distance in the game), different min & max distance values and different spread.

<br>
<img src="Resonance_Audio_Soundfield.png" alt="Resonance_Audio_Soundfield.png" align="right" width="35%">
The last sound, the ambisonics sound is made using another of the Google resonance tools; <br><em> Resonance Audio Soundfield </em>
<br>
...
As you can see, an Resonance Audio Soundfield event does not have any parameters for tweeking distance or spread. When you load
...
I don't want to get too deep into unity sound inplemantation in this post, but I'll try to summarize.
So basically, in unity, i call the event with the FMOD Studio Event Emitter, with a boxcollider as trigger.
